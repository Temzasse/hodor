...
const customRuleEntries = [
  ["hodor/no-access-state-in-setstate", error],
  ["hodor/no-class-component", error],
  ["hodor/no-context-provider", error],
  ["hodor/no-create-ref", error],
  ["hodor/no-duplicate-key", error],
  ["hodor/no-implicit-children", error],
  ["hodor/no-implicit-key", error],
  ["hodor/no-implicit-ref", error],
  ["hodor/no-leaked-conditional-rendering", error],
  ["hodor/no-missing-context-display-name", error],
  ["hodor/no-misused-capture-owner-stack", error],
  ["hodor/no-nested-lazy-component-declarations", error],
  ["hodor/no-unnecessary-use-prefix", error],
  ["hodor/no-unused-class-component-members", error],
  ["hodor/no-unused-props", error],
  ["hodor/no-unused-state", error],
  ["hodor/no-use-context", error],
  ["hodor/no-key-after-spread", error],
  ["hodor/no-leaked-dollar", error],
  ["hodor/no-leaked-semicolon", error],
  ["hodor/no-namespace", error],
  ["hodor/context-name", error],
  ["hodor/function-definition", error],
  ["hodor/id-name", error],
  ["hodor/ref-name", error],
  ["hodor/no-find-dom-node", error],
  ["hodor/no-flush-sync", error],
  ["hodor/no-hydrate", error],
  ["hodor/no-render", error],
  ["hodor/no-use-form-state", error],
  ["hodor/no-leaked-event-listener", error],
  ["hodor/no-leaked-fetch", error],
  ["hodor/no-leaked-intersection-observer", error],
  ["hodor/no-leaked-interval", error],
  ["hodor/no-leaked-resize-observer", error],
  ["hodor/no-leaked-timeout", error],
